...
class BlueprintEngine {
    static generate(classification, isParked = false) {
     ...
     */
    static generateBlueprint(classification, isParked = false) {
        ...
        const verificationStatus = classification.confidence === 'HIGH'
            ? 'OBSERVED'
            : classification.confidence === 'MEDIUM'
                ? 'INFERRED'
                : 'REQUIRES CLIENT APPROVAL';
        const statusLabel = classification.confidence === 'HIGH'
     ...
     */
    static getGenericUnknownBlueprint() {
        return [
            {
                pageName: 'Home',
