...
class AccessibilityAnalyzer {
    static analyze(pages, evidenceRegistry) {
        ...
        const wcagDisclaimer = 'This automated technical check inspects detectable DOM signals (alt attributes, heading hierarchy, form controls). It does NOT constitute a full WCAG 2.1/2.2 legal compliance guarantee, which requires extensive manual assistive technology testing.';
