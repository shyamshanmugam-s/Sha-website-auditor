...
exports.CONFIG = {
    ...
    AUDITS_DIR: path_1.default.resolve(process.cwd(), 'data', 'audits'),
    SCREENSHOTS_DIR: path_1.default.resolve(process.cwd(), 'data', 'screenshots'),
    PDFS_DIR: path_1.default.resolve(process.cwd(), 'data', 'pdfs'),
};
