...
exports.SalesReportSynthesizer = void 0;
const industryClassifier_js_1 = require("../classification/industryClassifier.js");
const blueprintEngine_js_1 = require("../classification/blueprintEngine.js");
const domainTokenizer_js_1 = require("../classification/domainTokenizer.js");
class SalesReportSynthesizer {
    /**
    ...
    static synthesize(audit) {
        ...
        const classification = industryClassifier_js_1.IndustryClassifier.classify(audit);
        ...
        const blueprintResult = blueprintEngine_js_1.BlueprintEngine.generateBlueprint(classification, isParkedOrIncomplete);
     ...
     */
    static extractBusinessName(audit) {
        ...
        if (audit.config?.url) {
            const formatted = domainTokenizer_js_1.DomainTokenizer.formatTitleFromDomain(audit.config.url);
     ...
     */
    static detectParkedOrIncomplete(audit) {
     ...
     */
    static extractWhatIsWorking(audit, isParked) {
        const items = [];
        const pages = audit.pages || [];
        const homePage = pages[0];
        if (!homePage) {
     ...
     */
    static selectTopOpportunities(audit, isParked, bizInfo, locInfo) {
        const opportunities = [];
        const findings = audit.findings || [];
        const findFinding = (id, category) => {
     ...
     */
    static sanitizeClientReport(report) {
...
exports.SalesReportSynthesizer = SalesReportSynthesizer;
